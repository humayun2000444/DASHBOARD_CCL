...
const UserFormModal = ({
  ...
  const validateForm = () => {
    ...
    if (!formData.partnerId && !isUpdate) {
      newErrors.partnerId = "Partner is required";
    }
      ...
      <Box sx={style}>
        ...
        <Form onSubmit={handleFormSubmit}>
          <Grid container spacing={3}>
            ...
            {/* Partner Field with Conditional Disable */}
            <Grid item xs={12} md={4}>
              <Autocomplete
                options={[...partners].sort((a, b) =>
                  a.partnerName.localeCompare(b.partnerName)
                ...
                onChange={(event, newValue) => {
                  if (!isUpdate) {
                    // Only allow changing partner when not updating
                    handleFieldChange({
                      target: {
                        name: "partnerId",
                        value: newValue?.idPartner || "",
                ...
                renderInput={(params) => (
                  <TextField
                    ...
                    error={!!errors.partnerId}
                    helperText={errors.partnerId}
                    disabled={isUpdate} // Disable partner field when updating
                  />
                )}
              />
            </Grid>
