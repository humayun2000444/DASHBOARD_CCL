...
//
// const NewCallSummaryChart = ({ selectedFilter }) => {
//   // Chart State
...
//       const { startStamp, endStamp } = getTimestamps(selectedFilter); // Get timestamps based on the selected filter
//
//       const requestData = { startStamp, endStamp };
//       try {
//         const response = await axios.post(
//           "http://iptsp.cosmocom.net:5070/admin/DashBoard/getIntervalWiseCall", requestData
//         );
...
// };
//
// export default NewCallSummaryChart;
